...
public class createExcelfile {
	 public static void main(String []args) {
			...
			try {
				FileOutputStream fileOut = new FileOutputStream("g://read//test11.xls");
				...
				HSSFRow row19 = worksheet.createRow((short) 14);
				HSSFRow row20 = worksheet.createRow((short) 14);
				...
				@SuppressWarnings("deprecation")
				HSSFCell cellA18 = row18.createCell((short) 0);
				@SuppressWarnings("deprecation")
				HSSFCell cellA19 = row19.createCell((short) 1);
				@SuppressWarnings("deprecation")
				HSSFCell cellA20 = row20.createCell((short) 2);
				@SuppressWarnings("deprecation")
				HSSFCell cellA21 = row21.createCell((short) 3);
				@SuppressWarnings("deprecation")
